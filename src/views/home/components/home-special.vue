<template>
  <HomePanel title="最新专题">
    ...
    <div class="special-list" ref="target" >
     <template v-if="homeSpecial.length">
      <div class="special-item" v-for="item in homeSpecial" :key="item.id">
        <RouterLink to="/">
     ...
     <div v-else class="skeleton">
        <XtxSkeleton class="item" v-for="i in 3" :key="i" animated bg="#e4e4e4" width="404px" height="380px"/>
     </div>
...
export default {
  ...
  setup () {
    ...
    return {homeSpecial:result, target}
  }
}
</script>
